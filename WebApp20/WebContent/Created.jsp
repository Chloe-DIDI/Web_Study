...
<div id="bbs">
   ...
   <form action="Created_ok.jsp" method="post" name="myForm">
      <div id="bbsCreated">
         <div class="bbsCreated_bottomLine">
            <dl>
               <dt>제&nbsp;&nbsp;&nbsp;&nbsp;목</dt>
         ...
         <div id="bbsCreated_noLine">
            <dl>
               <dt>패스워드</dt>
               <dd><input type="password" name="pwd" size="35" maxlength="10" class="boxTF">
               &nbsp;(게시물 수정 및 삭제 시 필요~!!!)
               </dd>
            </dl>
         </div><!-- close #bbsCreated_noLine -->
         ...
         <div id="bbsCreated_footer">
            ...
            <input type="reset" value="다시입력" class="btn2" onclick="document.myForm.subject.fouse();">
