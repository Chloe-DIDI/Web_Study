...
INSERT INTO TBL_MEMBER(SID, NAME, TEL) VALUES(MEMBERSEQ.NEXTVAL, '정미화', '010-2222-2222');
...
, CONSTRAINT MEMBERSCORE_SID_FK FOREIGN KEY(SID)
             REFERENCES TBL_MEMBER(SID));           ----------------------------> 이거 체크!!어케작성하는지
...
1	김소연	010-1111-1111	91	81	71
2	정미화	010-2222-2222	80	70	60
3	이찬호	010-3333-3333	-1	-1	-1
4	장진하	010-4444-4444	-1	-1	-1
5	이다영	010-5555-5555	-1	-1	-1
*/
...
--○ 자식테이블의 참조데이터 레코드 수 확인  -▶ 확인을 왜 할까? 삭제 가능여부를 보기 위해서..
SELECT COUNT(*) AS COUNT
FROM TBL_MEMBERSCORE
WHERE SID=1;
--> 한 줄 구성
